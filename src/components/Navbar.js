...
export default function Navbar(props) {
  return (
    <>
    <nav className={`navbar navbar-expand bg-${props.mode} navbar-${props.mode}`}>
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className="nav-link active" aria-current="page" to="/">{props.subHeading}</Link>
        </li>
        <li className="nav-item">
    ...
    <div className="b-">
    <button className="bg-primary rounded mx-2"  onClick={()=> {props.toggleMode('primary')}} style={{height: '30px', width:'30px'}}></button>
    ...
    {/* this above button where added to increase the knowledge about onClick feature */}
